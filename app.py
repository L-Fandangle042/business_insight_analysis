...
st.write("The analysis, data and the cleaning/mainpulation vs code files that are used here are available via the repository, titled [Exploration.ipynb](https://github.com/L-Fandangle042/business_insight_analysis/blob/main/Exploration.ipynb)")
